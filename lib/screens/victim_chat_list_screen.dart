            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  ChoiceChip(
                    label: Text(
                        context.read<AppSettingsProvider>().t('filter_active')),
                  ...
                  ChoiceChip(
                    label: Text(
                        context.read<AppSettingsProvider>().t('filter_all')),
                            ...
                            children: <Widget>[
                              ...
                              if (isCancelled)
                                isDeleting
                                    ...
                                    : IconButton(
                                        tooltip: settings
                                            .t('tooltip_delete_cancelled_chat'),
                                        icon: const Icon(Icons.delete_outline),
                                        onPressed: () =>
                                            _confirmDeleteCancelledChat(
                                                sosId: sosId),
                                      ),
                              const SizedBox(width: 4),
                              Icon(
